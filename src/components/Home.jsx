...
export default function Home() {
  return (
    <section id="home" className="vt-hero">
      ...
      <span
        className="vt-float-a"
        style={{ right: "12%", top: "18%", opacity: 0.55 }}
      >
        <Deco name="crane" size={110} id={1} />
      </span>
      <span
        className="vt-float-b"
        style={{ right: "5%", top: "48%", opacity: 0.45 }}
      >
        <Deco name="plane" size={72} />
      </span>
      <span
        className="vt-float-c"
        style={{ right: "22%", bottom: "20%", opacity: 0.35 }}
      >
        <Deco name="boat" size={88} />
      </span>
      <span
        className="vt-float-d"
        style={{ right: "38%", top: "12%", opacity: 0.6 }}
      >
      ...
      <div className="vt-hero-inner">
        <div className="vt-hero-content">
          ...
          <h1
            className="t-display"
            style={{ marginBottom: "var(--s-3)", color: "var(--ink-1)" }}
          >
            Hello, I'm
            <br />
          ...
          >
            Full Stack Developer with {new Date().getFullYear() - 2021}+ years
            of experience building scalable and maintainable web applications
            using React.js, TypeScript, Node.js, PostgreSQL, and MongoDB.
            Expertise in frontend architecture, backend API development,
            database design, and performance optimization, with a proven track
            record of delivering enterprise-grade solutions.
          </p>
      ...
      >
        ...
        />
        <span className="t-eyebrow" style={{ fontSize: "0.65rem" }}>
          scroll
        </span>
      </div>
    </section>
