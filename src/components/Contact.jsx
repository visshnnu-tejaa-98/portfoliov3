    ...
    <section id="contact" className="vt-section vt-section-alt">
      <div className="vt-container vt-container--narrow">
        ...
        >
          ...
          collaborations. Drop me a message and I'll get back to you promptly.
        </p>

        {/* Contact cards */}
        <div
          className="vt-contact-grid"
          style={{ marginBottom: "var(--s-10)" }}
        >
          {contacts.map((c) => (
            <div
              key={c.label}
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div
                  className="t-eyebrow"
                  style={{ marginBottom: 3, color: c.avatarFg }}
                >
                  {c.label}
                </div>
                {c.href ?
                  <a
                    ...
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.color = c.avatarFg)
                    }
                    onMouseLeave={(e) =>
                ...
                <button
                  ...
                  style={{
                    ...
                    color:
                      ...
                      : "var(--ink-4)",
                    background:
                      copied === c.label ? "var(--matcha-soft)" : "transparent",
                    border:
                      copied === c.label ?
                        "1px solid var(--matcha)"
                  ...
                  aria-label={
                    copied === c.label ? "Copied!" : `Copy ${c.label}`
                  }
                >
                  {copied === c.label ?
                    <CheckIcon />
        ...
        >
          ...
          <div>
            <div className="t-eyebrow" style={{ marginBottom: "var(--s-2)" }}>
              Ready to work together?
            </div>
            <h3 style={{ margin: "0 0 var(--s-2) 0", fontSize: "1.2rem" }}>
          ...
          <a
            href="mailto:visshnnutejaa@gmail.com"
            className="btn btn--accent btn--lg vt-cta-btn"
            style={{ flexShrink: 0 }}
          >
        ...
        >
          ...
          >
            ...
            >
              C V Visshnnu Tejaa · {new Date().getFullYear()}
            </span>
            <Deco name="sakura" size={14} />
          </div>
          {/* Copyright */}
          ...
          >
            © {new Date().getFullYear()} C V Visshnnu Tejaa. All rights
            reserved.
          </div>
        </div>
      </div>
